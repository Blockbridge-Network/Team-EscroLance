      ...
      <div className="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
        <main>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md mt-6">
            ...
            <p className="text-gray-500 mb-4">{job.salary} / Year</p>
          </div>
        </main>
        ...
        <aside>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-black text-xl font-bold mb-6">Company Info</h3>
            ...
            <p className="text-black my-2 bg-indigo-500 p-2 font-bold">
            { job.company.contactEmail }
            </p>

            <h3 className="text-black text-xl">Contact Phone:</h3>

            <p className="text-black my-2 bg-indigo-500 p-2 font-bold">{ job.company.contactPhone }</p>
          </div>
